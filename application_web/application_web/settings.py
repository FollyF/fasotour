...
SECRET_KEY = config('SECRET_KEY')  # Utilisation de
...
STATICFILES_DIRS = [
    BASE_DIR / 'gestion_cycle' /'static',
]

MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'gestion_cycle' /'media'
...
LOGIN_URL = '/connexion/'
LOGIN_REDIRECT_URL = '/'  # optionnel, après connexion